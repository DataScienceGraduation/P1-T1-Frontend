  ...
  return (
    <Layout>
        ...
        <div className='grid grid-cols-1 gap-5 md:grid-cols-12'>
          <div className='grid gap-y-5 md:gap-5 md:col-span-7 md:grid-cols-2'>
            ...
            <div className='relative col-span-1'>
              <img src='https://placehold.co/400x600' alt='placeholder' className='relative w-full rounded-sm shadow-sm'></img>
              <span className='text-2xl z-[50] font-body font-bold tracking-[0.2em] text-shadow absolute bottom-6 right-4'>
                #ATHLETE
              </span>
            </div>
            <div className='relative col-span-1'>
              <img src='https://placehold.co/400x600' alt='placeholder' className='relative rounded-sm shadow-sm'></img>
              <span className='text-2xl z-[50] font-body font-bold tracking-[0.2em] text-shadow absolute bottom-6 right-4'>
                #ATHLETE
              </span>
            </div>
          ...
          <div className='hidden md:col-span-5 md:block'>
            <img src='https://placehold.co/600x800' alt='placeholder' className='relative object-cover w-auto h-full overflow-hidden bg-cover rounded-sm shadow-sm'/>
          </div>
        </div>
      </Section>
      ...
      <div className='relative py-12'>
        <img src='https://placehold.co/1000x400' className='relative object-cover w-full bg-cover h-120' alt='a group of people'></img>
        <Button text='SHOP NOW' variant='solid' color='secondary' className='absolute bottom-0 w-56 mx-auto ' />

      </div>
      <Section>
        <div className='grid grid-cols-1 gap-5 md:grid-cols-12'>
          <img src='https://placehold.co/400x300' alt='placeholder' className='w-full h-full col-span-1 rounded-sm shadow-md md:col-span-7'></img>

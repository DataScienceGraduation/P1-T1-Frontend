...
const Product: React.FC = () => {
    ...
    return(
        ...
        <div className='flex flex-row flex-wrap justify-center order-2 md:hidden md:space-y-1 md:flex-col md:order-1'>
            <img src={product['image']} alt='' className='w-24 h-32 mx-1 md:mr-0 md:ml-auto' onClick={() => setActiveImage(images.img1)}></img>
        ...
        <div className='flex flex-col justify-start order-3 gap-2 md:col-span-3'>
            ...
            <h3 className='text-2xl font-bold font-body'>{product['name']}</h3>
            ...
            <h6 className='text-lg font-medium text-center'>USD {product['price']}</h6>
            <div>
            ...
            <img src={product['image']} alt='' className='w-24 h-32 mx-2 rounded-xl' onClick={() => setActiveImage(product['image'])}></img>
            ...
            <Button onClick={addToCart} className="mt-4" text = "ADD TO MY BASKET" color="primary"/>
            </div>
        </div>
        </div>
        </Section>

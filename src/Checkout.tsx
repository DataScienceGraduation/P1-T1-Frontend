            ...
            <Section>
                <div className='grid gap-4 md:grid-cols-5'>
                    <div className='space-y-4 md:col-span-3'>
                        ...
                        <h2 className='text-xl font-bold font-heading'>Delivery Time</h2>
                        <div className='px-4 py-6 space-y-4 shadow-sm bg-secondary border-sm'> 
                        ...
                        <div className='px-4 py-6 space-y-4 shadow-sm bg-secondary border-sm'>
                            <input type='radio' id='cash' name='payment' value='Cash on delivery'></input>
                            <label htmlFor='cash' className='pl-2 font-bold'>Credit Card</label>
                        </div>
                    </div>
                    <div className='space-y-4 md:col-span-2'>
                        ...
                        <div className='px-4 py-6 space-y-4 shadow-sm bg-secondary border-sm'>
                            ...
                            <p className='block px-4 py-4 mx-auto my-4 space-x-20 text-center border-2 rounded-sm shadow-sm border-primary text-bold'>
                                <span className='font-bold'>Total</span><span className='text-gray-700'>EGP 4,000</span>
                            </p>
                            <Button text='Place Order' color='primary'/>
                        </div>
                    </div>
                </div>
            </Section>
